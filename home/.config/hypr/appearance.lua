-- Environment variables, colors, decoration, and animations.
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = { V.color_active_1, V.color_active_2 }, angle = 45 },
            inactive_border = V.color_inactive,
        },
